...
{
Modified for Work Engine use because filenames differ between 32 and 64-bit (also different po file, but just pick the one with the most data...)
...
begin
  {$ifdef altname}
  s:=StringReplace(s, 'Cheat Engine','Work Engine',[rfReplaceAll, rfIgnoreCase]);
