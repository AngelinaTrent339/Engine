object formSettings: TformSettings
    ...
    object pcSetting: TPageControl
      ...
      object GeneralSettings: TTabSheet
        ...
        object cbCenterOnPopup: TCheckBox
          ...
          Width = 601
          Height = 21
          Caption = 'Center Work Engine when bringing to front'
          Checked = True
          State = cbChecked
          TabOrder = 2
        end
        object EditUpdateInterval: TEdit
          ...
          Height = 24
          Hint = 
            'The number of milliseconds that Work Engine will wait before re' +
      ...
      object CodeFinder: TTabSheet
        ...
        object Label4: TLabel
          ...
          Align = alTop
          Caption = 
            'There are 2 ways Work Engine can find the addresss of code that' +
  ...
  object OpenDialog1: TOpenDialog
    DefaultExt = 'DLL'
    Filter = 'Work Engine Plugins (*.dll)|*.dll'
    Left = 52
    Top = 264
  end
