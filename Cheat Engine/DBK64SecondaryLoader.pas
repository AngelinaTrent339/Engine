...
resourcestring
  ...
  rsModuleLoaderFailedToMapKernelDriver = 'ModuleLoader failed to map wekernel64.sys to memory';
...
begin
  ...
  try
   ...
   // ShowMessage('Part 1');
    ...
    ml:=TModuleLoader.create(CheatEngineDir+'wekernel64.sys');
   ...
   // ShowMessage('Part 3');
    ...
    begin
      ...
      showmessage(rsModuleLoaderFailedToMapKernelDriver);
