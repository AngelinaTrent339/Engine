...
- `vmcall_ud_cycles`: avg cycles for VMCALL/VMMCALL â†’ injected #UD path
- `ud2_ud_cycles`: avg cycles for UD2 â†’ #UD path
...
- On systems with Hyperâ€‘V or other HVs, `hv_present_bit=1` and no DBVM signature â†’ `OTHER_HYPERVISOR`.
